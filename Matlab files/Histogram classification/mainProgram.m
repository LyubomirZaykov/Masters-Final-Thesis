...
[counts,x]=imhist(currImage);
% imhist(currImage);
currCoefs=polyfit(counts,x,1);
coefs(i,1)=currCoefs(1);
coefs(i,2)=currCoefs(2);
end
coefs=coefs';
trainInput=coefs(:,[1:30,36:65,71:100,106:135,141:170]);
testInput=coefs(:,[31:35,66:70,101:105,136:140,171:175]);
