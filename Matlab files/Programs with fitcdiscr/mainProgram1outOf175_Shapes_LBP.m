...
LBPFeatures=[LBPFeatures;features];
...
Feature9=Feature7/Feature8;
%%
% Извличането на характерните признаци
props=[Feature2,Feature3,Feature4,Feature5,Feature9];
...
[pc ,scores ,pca]=pca(LBPFeatures);
scores=scores(:,1:13);
PollenFeatures=[PollenFeatures,scores];
%%
